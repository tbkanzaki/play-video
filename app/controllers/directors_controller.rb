class DirectorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @director.save
        format.html { redirect_to directors_url, notice: "Diretor cadastrado com sucesso!" }
  ...
  def update
    respond_to do |format|
      if @director.update(director_params)
        format.html { redirect_to directors_url, notice: "Diretor alterado com sucesso!" }
  ...
  private
    ...
    def director_params
      params.require(:director).permit(:name, :nationality, :date_birth, :genre_id)
    end
end
